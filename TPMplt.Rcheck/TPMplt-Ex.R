...
##D SummaryTable <- API4TMZ(conditions, "/Your_Working_Directory/")
##D SummaryTable
## End(Not run)
...
##D variable3 <- c("factor31", "factor32", "factor33", "factor34")
##D conditions <- list(variable1, variable2, variable3)
##D SummaryTable <- TMZdatainput(Cdl=conditions, wd="/Your_Working_Directory/")
##D SummaryTable
## End(Not run)
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("TPMplt", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("basic3d")
### * basic3d
