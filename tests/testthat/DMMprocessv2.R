...
testfunc <- function(m, lgbase=exp(1), InteractMode=FALSE, consfuncPRT=FALSE, legendcex=0.65, legendloc="bottomright"){
  # test section
  ...
  if(InteractMode == TRUE){
    ...
    paras <- list(A = A, alpha = alpha.StressInd, n = n.Power, Q = Q.ActivEnerg)
  }
